import{_ as s,c as i,o as a,R as n}from"./chunks/framework.Tt2DsVC6.js";const o=JSON.parse('{"title":"Nginx 配置 vue 项目简单实例","description":"","frontmatter":{},"headers":[],"relativePath":"blog/article/2025/1.md","filePath":"blog/article/2025/1.md","lastUpdated":1776652025000}'),l={name:"blog/article/2025/1.md"},p=n(`<h1 id="nginx-配置-vue-项目简单实例" tabindex="-1">Nginx 配置 vue 项目简单实例 <a class="header-anchor" href="#nginx-配置-vue-项目简单实例" aria-label="Permalink to &quot;Nginx 配置 vue 项目简单实例&quot;">​</a></h1><div class="language-nginx vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">nginx</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># For more information on configuration, see:</span></span>
